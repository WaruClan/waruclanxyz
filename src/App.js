...
import {ConnectWallet, ThirdwebNftMedia, useContract, useAddress, useBalance, useOwnedNFTs, Web3Button} from "@thirdweb-dev/react";
  ...
  return (
    <div className="container">
      <main className="main">
        ...
        <p className="description">Waru Token with 21 million tokens is being replaced with a new token called Waru V2, with a total supply of 2.1 million. The new token will be native and adopt the same ticker "WARU". Holders of the old version should burn the token to receive the new, at a ratio of 10:1 units, maintaining the same value. Before launching the new token, a snapshot of the old token will be taken.</p>
        <hr/>
